...
urlpatterns = [
    ...
    url(r'^usuarios/(?P<pk>[0-9]+)/reservasUsuarios/(?P<pk1>[0-9]+)/$', views.ReservaMobiBusDetail.as_view()),
    url(r'^conductoresTranvia/(?P<pk>[0-9]+)/conductoresTranvia/$', views.ConductorTranviaList.as_view()),
    url(r'^conductoresTranvia/(?P<pk>[0-9]+)/conductoresTranvia/(?P<pk1>[0-9]+)$', views.ConductorTranviaDetail.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/coordenadasTranvia/$', views.CoordenadasTranviaList.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/coordenadasTranvia/(?P<pk1>[0-9]+)/$', views.CoordenadasTranviaDetail.as_view()),
    ...
    url(r'^tranvias/(?P<pk>[0-9]+)/reportesTranvias/(?P<pk1>[0-9]+)/$', views.ReporteTranviaDetail.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/conductoresMoviBus/$', views.ConductorMoviBusList.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/conductoresMoviBus/(?P<pk1>[0-9]+)/$', views.ConductorMoviBusDetail.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/coordenadasMovibus/$', views.CoordenadasMoviBusList.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/coordenadasMovibus/(?P<pk1>[0-9]+)/$', views.CoordenadasMoviBusDetail.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/reportesMovibuses/$', views.ReporteMoviBusList.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/reportesMovibuses/(?P<pk1>[0-9]+)/$', views.ReporteMoviBusDetail.as_view()),
