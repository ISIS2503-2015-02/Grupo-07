...
urlpatterns = [
    ...
    url(r'^reservasUsuario/(?P<pk>[A-Za-z0-9]+)/$', ReservaMobiBusDetail.as_view()),
    url(r'^conductoresTranvia/(?P<pk>[A-Za-z0-9]+)/$', ConductorTranviaDetail.as_view()),
    url(r'^tranvias/(?P<pk>[A-Za-z0-9]+)/$', TranviaDetail.as_view()),
    url(r'^lineas/(?P<pk>[A-Za-z0-9]+)/$', LineaDetail.as_view()),
    url(r'^alertas/(?P<pk>[A-Za-z0-9]+)/$', AlertaTranviaDetail.as_view()),
    url(r'^coordenadasTranvia/(?P<pk>[A-Za-z0-9]+)/$', ConductorTranviaDetail.as_view()),
    url(r'^conductoresMovibus/(?P<pk>[A-Za-z0-9]+)/$', ConductorMoviBusDetail.as_view()),
    url(r'^movibuses/(?P<pk>[A-Za-z0-9]+)/$', MoviBusDetail.as_view()),
    url(r'^coordenadasMovibus/(?P<pk>[A-Za-z0-9]+)/$', ConductorMoviBusDetail.as_view()),
    url(r'^estaciones/(?P<pk>[A-Za-z0-9]+)/$', EstacionVcubsDetail.as_view()),
    url(r'^vcubs/(?P<pk>[A-Za-z0-9]+)/$', VcubsDetail.as_view()),
    url(r'^reportesMovibus/(?P<pk>[A-Za-z0-9]+)/$', ReservaMobiBusDetail.as_view()),
    url(r'^reportesTranvia/(?P<pk>[A-Za-z0-9]+)/$', ReporteTranviaDetail.as_view()),
    url(r'^recorridosMovibus/$', RecorridoMoviBusList.as_view()),
    url(r'^recorridosMovibus/(?P<pk>[A-Za-z0-9]+)/$', RecorridoMoviBusDetail.as_view()),
    url(r'^recorridosTranvia/$', RecorridoTranviaList.as_view()),
    url(r'^recorridosTranvia/(?P<pk>[A-Za-z0-9]+)/$', RecorridoTranviaDetail.as_view()),
]
