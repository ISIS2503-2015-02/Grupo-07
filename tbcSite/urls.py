...
urlpatterns = [
    ...
    #url(r'^conductoresMoviBus/$', views.ConductorMoviBusList.as_view()),
    ...
    url(r'^usuarios/(?P<pk>[0-9]+)/reservasUsuarios/$', views.ReservaMobiBusList.as_view()),
    url(r'^usuarios/(?P<pk>[0-9]+)/reservasUsuarios/(?P<pk>[0-9]+)/$', views.ReservaMobiBusDetail.as_view()),
    url(r'^conductoresTranvia/(?P<pk>[0-9]+)/conductoresTranvia/$', views.ConductorTranviaList.as_view()),
    url(r'^conductoresTranvia/(?P<pk>[0-9]+)/conductoresTranvia/(?P<pk>[0-9]+)$', views.ConductorTranviaDetail.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/coordenadasTranvia/$', views.CoordenadasTranviaList.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/coordenadasTranvia/(?P<pk>[0-9]+)/$', views.CoordenadasTranviaDetail.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/alertas/$', views.AlertaTranviaList.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/alertas/(?P<pk>[0-9]+)/$', views.AlertaTranviaDetail.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/reportesTranvias/$', views.ReporteTranviaList.as_view()),
    url(r'^tranvias/(?P<pk>[0-9]+)/reportesTranvias/(?P<pk>[0-9]+)/$', views.ReporteTranviaDetail.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/conductoresMoviBus/$', views.ConductorMoviBusList.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/conductoresMoviBus/(?P<pk>[0-9]+)/$', views.ConductorMoviBusDetail.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/coordenadasMovibus/$', views.CoordenadasMoviBusList.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/coordenadasMovibus/(?P<pk>[0-9]+)/$', views.CoordenadasMoviBusDetail.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/reportesMovibuses/$', views.ReporteMoviBusList.as_view()),
    url(r'^movibuses/(?P<pk>[0-9]+)/reportesMovibuses/(?P<pk>[0-9]+)/$', views.ReporteMoviBusDetail.as_view()),
    url(r'^estaciones/(?P<pk>[0-9]+)/vcubs/$', views.VcubsList.as_view()),
    url(r'^estaciones/(?P<pk>[0-9]+)/vcubs/(?P<pk>[0-9]+)/$', views.VcubsDetail.as_view()),
